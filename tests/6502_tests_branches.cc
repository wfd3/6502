...
TEST_F(MOS6502BranchTests, BCCBranchesWhenVSet) {
	...
	cpu.setFlagC(false);
	BranchesWhenFlagSet(MOS6502::RESET_VECTOR, 0xF, Opcodes::BCC_REL);
}
	
TEST_F(MOS6502BranchTests, BCCBranchesWhenVSetForward) {
	cpu.TestReset(0x2000);
	cpu.setFlagC(false);
	BranchesWhenFlagSet(0x2000, 0xF, Opcodes::BCC_REL);
}
	
TEST_F(MOS6502BranchTests, BCCBranchesWhenVSetAcrossPage) {
	cpu.TestReset(0x20F3);
	cpu.setFlagC(false);
	BranchesWhenFlagSet(0x20F3, 0xf, Opcodes::BCC_REL);
}

TEST_F(MOS6502BranchTests, BCCDoesNotBranchesWhenVIsNotSet) {
	cpu.TestReset(MOS6502::RESET_VECTOR);
	cpu.setFlagC(true);
	BranchesWhenFlagSet(MOS6502::RESET_VECTOR, 0x0, Opcodes::BCC_REL);
}
...
TEST_F(MOS6502BranchTests, BCSBranchesWhenVSet) {
	cpu.TestReset(MOS6502::RESET_VECTOR);
	cpu.setFlagC(true);
	BranchesWhenFlagSet(MOS6502::RESET_VECTOR, 0xF, Opcodes::BCS_REL);
}
	
TEST_F(MOS6502BranchTests, BCSBranchesWhenVSetForward) {
	cpu.TestReset(0x2000);
	cpu.setFlagC(true);
	BranchesWhenFlagSet(0x2000, 0xF, Opcodes::BCS_REL);
}
	
TEST_F(MOS6502BranchTests, BCSBranchesWhenVSetAcrossPage) {
	cpu.TestReset(0x20F3);
	cpu.setFlagC(true);
	BranchesWhenFlagSet(0x20F3, 0xf, Opcodes::BCS_REL);
}

TEST_F(MOS6502BranchTests, BCSDoesNotBranchesWhenVIsNotSet) {
	cpu.TestReset(MOS6502::RESET_VECTOR);
	cpu.setFlagC(false);
	BranchesWhenFlagSet(MOS6502::RESET_VECTOR, 0x0, Opcodes::BCS_REL);
}
...
TEST_F(MOS6502BranchTests, BEQBranchesWhenVSet) {
	cpu.TestReset(MOS6502::RESET_VECTOR);
	cpu.setFlagZ(true);
	BranchesWhenFlagSet(MOS6502::RESET_VECTOR, 0xF, Opcodes::BEQ_REL);
}
	
TEST_F(MOS6502BranchTests, BEQBranchesWhenVSetForward) {
	cpu.TestReset(0x2000);
	cpu.setFlagZ(true);
	BranchesWhenFlagSet(0x2000, 0xF, Opcodes::BEQ_REL);
}
	
TEST_F(MOS6502BranchTests, BEQBranchesWhenVSetAcrossPage) {
	cpu.TestReset(0x20F3);
	cpu.setFlagZ(true);
	BranchesWhenFlagSet(0x20F3, 0xf, Opcodes::BEQ_REL);
}

TEST_F(MOS6502BranchTests, BEQDoesNotBranchesWhenVIsNotSet) {
	cpu.TestReset(MOS6502::RESET_VECTOR);
	cpu.setFlagZ(false);
	BranchesWhenFlagSet(MOS6502::RESET_VECTOR, 0x0, Opcodes::BEQ_REL);
}
...
TEST_F(MOS6502BranchTests, BMIBranchesWhenVSet) {
	cpu.TestReset(MOS6502::RESET_VECTOR);
	cpu.setFlagN(true);
	BranchesWhenFlagSet(MOS6502::RESET_VECTOR, 0xF, Opcodes::BMI_REL);
}
	
TEST_F(MOS6502BranchTests, BMIBranchesWhenVSetForward) {
	cpu.TestReset(0x2000);
	cpu.setFlagN(true);
	BranchesWhenFlagSet(0x2000, 0xF, Opcodes::BMI_REL);
}
	
TEST_F(MOS6502BranchTests, BMIBranchesWhenVSetAcrossPage) {
	cpu.TestReset(0x20F3);
	cpu.setFlagN(true);
	BranchesWhenFlagSet(0x20F3, 0xf, Opcodes::BMI_REL);
}

TEST_F(MOS6502BranchTests, BMIDoesNotBranchesWhenVIsNotSet) {
	cpu.TestReset(MOS6502::RESET_VECTOR);
	cpu.setFlagN(false);
	BranchesWhenFlagSet(MOS6502::RESET_VECTOR, 0x0, Opcodes::BMI_REL);
}
...
TEST_F(MOS6502BranchTests, BNEBranchesWhenVSet) {
	cpu.TestReset(MOS6502::RESET_VECTOR);
	cpu.setFlagZ(false);
	BranchesWhenFlagSet(MOS6502::RESET_VECTOR, 0xF, Opcodes::BNE_REL);
}
	
TEST_F(MOS6502BranchTests, BNEBranchesWhenVSetForward) {
	cpu.TestReset(0x2000);
	cpu.setFlagZ(false);
	BranchesWhenFlagSet(0x2000, 0xF, Opcodes::BNE_REL);
}
	
TEST_F(MOS6502BranchTests, BNEBranchesWhenVSetAcrossPage) {
	cpu.TestReset(0x20F3);
	cpu.setFlagZ(false);
	BranchesWhenFlagSet(0x20F3, 0xf, Opcodes::BNE_REL);
}

TEST_F(MOS6502BranchTests, BNEDoesNotBranchesWhenVIsNotSet) {
	cpu.TestReset(MOS6502::RESET_VECTOR);
	cpu.setFlagZ(true);
	BranchesWhenFlagSet(MOS6502::RESET_VECTOR, 0x0, Opcodes::BNE_REL);
}
...
TEST_F(MOS6502BranchTests, BPLBranchesWhenVSet) {
	cpu.TestReset(MOS6502::RESET_VECTOR);
	cpu.setFlagN(false);
	BranchesWhenFlagSet(MOS6502::RESET_VECTOR, 0xF, Opcodes::BPL_REL);
}
	
TEST_F(MOS6502BranchTests, BPLBranchesWhenVSetForward) {
	cpu.TestReset(0x2000);
	cpu.setFlagN(false);
	BranchesWhenFlagSet(0x2000, 0xF, Opcodes::BPL_REL);
}
	
TEST_F(MOS6502BranchTests, BPLBranchesWhenVSetAcrossPage) {
	cpu.TestReset(0x20F3);
	cpu.setFlagN(false);
	BranchesWhenFlagSet(0x20F3, 0xf, Opcodes::BPL_REL);
}

TEST_F(MOS6502BranchTests, BPLDoesNotBranchesWhenVIsNotSet) {
	cpu.TestReset(MOS6502::RESET_VECTOR);
	cpu.setFlagN(true);
	BranchesWhenFlagSet(MOS6502::RESET_VECTOR, 0x0, Opcodes::BPL_REL);
}
...
TEST_F(MOS6502BranchTests, BVCBranchesWhenVSet) {
	cpu.TestReset(MOS6502::RESET_VECTOR);
	cpu.setFlagV(false);
	BranchesWhenFlagSet(MOS6502::RESET_VECTOR, 0xF, Opcodes::BVC_REL);
}
	
TEST_F(MOS6502BranchTests, BVCBranchesWhenVSetForward) {
	cpu.TestReset(0x2000);
	cpu.setFlagV(false);
	BranchesWhenFlagSet(0x2000, 0xF, Opcodes::BVC_REL);
}
	
TEST_F(MOS6502BranchTests, BVCBranchesWhenVSetAcrossPage) {
	cpu.TestReset(0x20F3);
	cpu.setFlagV(false);
	BranchesWhenFlagSet(0x20F3, 0xf, Opcodes::BVC_REL);
}

TEST_F(MOS6502BranchTests, BVCDoesNotBranchesWhenVIsNotSet) {
	cpu.TestReset(MOS6502::RESET_VECTOR);
	cpu.setFlagV(true);
	BranchesWhenFlagSet(MOS6502::RESET_VECTOR, 0x0, Opcodes::BVC_REL);
}
...
TEST_F(MOS6502BranchTests, BVSBranchesWhenVSet) {
	cpu.TestReset(MOS6502::RESET_VECTOR);
	cpu.setFlagV(true);
	BranchesWhenFlagSet(MOS6502::RESET_VECTOR, 0xF, Opcodes::BVS_REL);
}
	
TEST_F(MOS6502BranchTests, BVSBranchesWhenVSetForward) {
	cpu.TestReset(0x2000);
	cpu.setFlagV(true);
	BranchesWhenFlagSet(0x2000, 0xF, Opcodes::BVS_REL);
}
	
TEST_F(MOS6502BranchTests, BVSBranchesWhenVSetAcrossPage) {
	cpu.TestReset(0x20F3);
	cpu.setFlagV(true);
	BranchesWhenFlagSet(0x20F3, 0xf, Opcodes::BVS_REL);
}

TEST_F(MOS6502BranchTests, BVSDoesNotBranchesWhenVIsNotSet) {
	cpu.TestReset(MOS6502::RESET_VECTOR);
	cpu.setFlagV(false);
	BranchesWhenFlagSet(MOS6502::RESET_VECTOR, 0x0, Opcodes::BVS_REL);
}
