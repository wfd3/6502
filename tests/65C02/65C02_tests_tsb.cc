...
class MOS65C02TSBTests : public testing::Test {
public:
...
TEST_F(MOS65C02TSBTests, TRBAbsolute) {
    Cycles_t UsedCycles, ExpectedCycles;
	Byte ins = cpu.Opcodes.TSB_ABS;
...
TEST_F(MOS65C02TSBTests, TRBZeroPage) {
    Cycles_t UsedCycles, ExpectedCycles;
	Byte ins = cpu.Opcodes.TSB_ZP;
