	...
	return  {
		...
		{ Opcodes.BRK_IMP,
		  { "brk", AddressingMode::Implied, 1, 7, InstructionFlags::None,
		    std::bind(&MOS6502::ins_brk, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.ORA_IDX,
		  { "ora", AddressingMode::IndirectX, 2, 6, InstructionFlags::None,
		    std::bind(&MOS6502::ins_ora, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.ORA_ZP,
		  { "ora", AddressingMode::ZeroPage, 2, 3, InstructionFlags::None,
		    std::bind(&MOS6502::ins_ora, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.ASL_ZP,
		  { "asl", AddressingMode::ZeroPage, 2, 5, InstructionFlags::None,
		    std::bind(&MOS6502::ins_asl, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.PHP_IMP,
		  { "php", AddressingMode::Implied, 1, 3, InstructionFlags::None,
		    std::bind(&MOS6502::ins_php, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.ORA_IMM,
		...
		{ Opcodes.BPL_REL,
		  { "bpl", AddressingMode::Relative, 2, 2, InstructionFlags::Branch,
		    std::bind(&MOS6502::ins_bpl, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.ORA_IDY,
		...
		{ Opcodes.CLC_IMP,
		  { "clc", AddressingMode::Implied, 1, 2, InstructionFlags::None,
		    std::bind(&MOS6502::ins_clc, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.ORA_ABY,
		...
		{ Opcodes.JSR_ABS,
		  { "jsr", AddressingMode::Absolute, 3, 6, InstructionFlags::None,
		    std::bind(&MOS6502::ins_jsr, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.AND_IDX,
		  { "and", AddressingMode::IndirectX, 2, 6, InstructionFlags::None,
		    std::bind(&MOS6502::ins_and, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.BIT_ZP,
		  { "bit", AddressingMode::ZeroPage, 2, 3, InstructionFlags::None,
		    std::bind(&MOS6502::ins_bit, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.AND_ZP,
		  { "and", AddressingMode::ZeroPage, 2, 3, InstructionFlags::None,
		    std::bind(&MOS6502::ins_and, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.ROL_ZP,
		  { "rol", AddressingMode::ZeroPage, 2, 5, InstructionFlags::None,
		    std::bind(&MOS6502::ins_rol, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.PLP_IMP,
		  { "plp", AddressingMode::Implied, 1, 4, InstructionFlags::None,
		    std::bind(&MOS6502::ins_plp, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.AND_IMM,
		...
		{ Opcodes.BMI_REL,
		  { "bmi", AddressingMode::Relative, 2, 2, InstructionFlags::Branch,
		    std::bind(&MOS6502::ins_bmi, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.AND_IDY,
		...
		{ Opcodes.SEC_IMP,
		  { "sec", AddressingMode::Implied, 1, 2, InstructionFlags::None,
		    std::bind(&MOS6502::ins_sec, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.AND_ABY,
		...
		{ Opcodes.RTI_IMP,
		  { "rti", AddressingMode::Implied, 1, 6, InstructionFlags::None,
		    std::bind(&MOS6502::ins_rti, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.EOR_IDX,
		  { "eor", AddressingMode::IndirectX, 2, 6, InstructionFlags::None,
		    std::bind(&MOS6502::ins_eor, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.EOR_ZP,
		  { "eor", AddressingMode::ZeroPage, 2, 3, InstructionFlags::None,
		    std::bind(&MOS6502::ins_eor, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.LSR_ZP,
		  { "lsr", AddressingMode::ZeroPage, 2, 5, InstructionFlags::None,
		    std::bind(&MOS6502::ins_lsr, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.PHA_IMP,
		  { "pha", AddressingMode::Implied, 1, 3, InstructionFlags::None,
		    std::bind(&MOS6502::ins_pha, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.EOR_IMM,
		...
		{ Opcodes.JMP_ABS,
		  { "jmp", AddressingMode::Absolute, 3, 3, InstructionFlags::None,
		    std::bind(&MOS6502::ins_jmp, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.EOR_ABS,
		...
		{ Opcodes.BVC_REL,
		  { "bvc", AddressingMode::Relative, 2, 2, InstructionFlags::Branch,
		    std::bind(&MOS6502::ins_bvc, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.EOR_IDY,
		...
		{ Opcodes.CLI_IMP,
		  { "cli", AddressingMode::Implied, 1, 2, InstructionFlags::None,
		    std::bind(&MOS6502::ins_cli, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.EOR_ABY,
		...
		{ Opcodes.RTS_IMP,
		  { "rts", AddressingMode::Implied, 1, 6, InstructionFlags::None,
		    std::bind(&MOS6502::ins_rts, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.ADC_IDX,
		  { "adc", AddressingMode::IndirectX, 2, 6, InstructionFlags::None,
		    std::bind(&MOS6502::ins_adc, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.ADC_ZP,
		  { "adc", AddressingMode::ZeroPage, 2, 3, InstructionFlags::None,
		    std::bind(&MOS6502::ins_adc, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.ROR_ZP,
		  { "ror", AddressingMode::ZeroPage, 2, 5, InstructionFlags::None,
		    std::bind(&MOS6502::ins_ror, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.PLA_IMP,
		  { "pla", AddressingMode::Implied, 1, 4, InstructionFlags::None,
		    std::bind(&MOS6502::ins_pla, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.ADC_IMM,
		...
		{ Opcodes.BVS_REL,
		  { "bvs", AddressingMode::Relative, 2, 2, InstructionFlags::Branch,
		    std::bind(&MOS6502::ins_bvs, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.ADC_IDY,
		...
		{ Opcodes.SEI_IMP,
		  { "sei", AddressingMode::Implied, 1, 2, InstructionFlags::None,
		    std::bind(&MOS6502::ins_sei, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.ADC_ABY,
		...
		{ Opcodes.STA_IDX,
		  { "sta", AddressingMode::IndirectX, 2, 6, InstructionFlags::None,
		    std::bind(&MOS6502::ins_sta, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.STY_ZP,
		  { "sty", AddressingMode::ZeroPage, 2, 3, InstructionFlags::None,
		    std::bind(&MOS6502::ins_sty, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.STA_ZP,
		  { "sta", AddressingMode::ZeroPage, 2, 3, InstructionFlags::None,
		    std::bind(&MOS6502::ins_sta, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.STX_ZP,
		  { "stx", AddressingMode::ZeroPage, 2, 3, InstructionFlags::None,
		    std::bind(&MOS6502::ins_stx, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.DEY_IMP,
		  { "dey", AddressingMode::Implied, 1, 2, InstructionFlags::None,
		    std::bind(&MOS6502::ins_dey, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.TXA_IMP,
		  { "txa", AddressingMode::Implied, 1, 2, InstructionFlags::None,
		    std::bind(&MOS6502::ins_txa, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.STY_ABS,
		...
		{ Opcodes.BCC_REL,
		  { "bcc", AddressingMode::Relative, 2, 2, InstructionFlags::Branch,
		    std::bind(&MOS6502::ins_bcc, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.STA_IDY,
		...
		{ Opcodes.TYA_IMP,
		  { "tya", AddressingMode::Implied, 1, 2, InstructionFlags::None,
		    std::bind(&MOS6502::ins_tya, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.STA_ABY,
		  { "sta", AddressingMode::AbsoluteY, 3, 5, InstructionFlags::None,
		    std::bind(&MOS6502::ins_sta, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.TXS_IMP,
		  { "txs", AddressingMode::Implied, 1, 2, InstructionFlags::None,
		    std::bind(&MOS6502::ins_txs, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.STA_ABX,
		  { "sta", AddressingMode::AbsoluteX, 3, 5, InstructionFlags::None,
		    std::bind(&MOS6502::ins_sta, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.LDY_IMM,
		  { "ldy", AddressingMode::Immediate, 2, 2, InstructionFlags::None,
		    std::bind(&MOS6502::ins_ldy, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.LDA_IDX,
		  { "lda", AddressingMode::IndirectX, 2, 6, InstructionFlags::None,
		    std::bind(&MOS6502::ins_lda, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.LDX_IMM,
		  { "ldx", AddressingMode::Immediate, 2, 2, InstructionFlags::None,
		    std::bind(&MOS6502::ins_ldx, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.LDY_ZP,
		...
		{ Opcodes.TAY_IMP,
		  { "tay", AddressingMode::Implied, 1, 2, InstructionFlags::None,
		    std::bind(&MOS6502::ins_tay, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.LDA_IMM,
		  { "lda", AddressingMode::Immediate, 2, 2, InstructionFlags::None,
		    std::bind(&MOS6502::ins_lda, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.TAX_IMP,
		  { "tax", AddressingMode::Implied, 1, 2, InstructionFlags::None,
		    std::bind(&MOS6502::ins_tax, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.LDY_ABS,
		...
		{ Opcodes.BCS_REL,
		  { "bcs", AddressingMode::Relative, 2, 2, InstructionFlags::Branch,
		    std::bind(&MOS6502::ins_bcs, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.LDA_IDY,
		...
		{ Opcodes.CLV_IMP,
		  { "clv", AddressingMode::Implied, 1, 2, InstructionFlags::None,
		    std::bind(&MOS6502::ins_clv, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.LDA_ABY,
		  { "lda", AddressingMode::AbsoluteY, 3, 4, InstructionFlags::PageBoundary,
		    std::bind(&MOS6502::ins_lda, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.TSX_IMP,
		  { "tsx", AddressingMode::Implied, 1, 2, InstructionFlags::None,
		    std::bind(&MOS6502::ins_tsx, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.LDY_ABX,
		...
		{ Opcodes.CPY_IMM,
		  { "cpy", AddressingMode::Immediate, 2, 2, InstructionFlags::None,
		    std::bind(&MOS6502::ins_cpy, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.CMP_IDX,
		  { "cmp", AddressingMode::IndirectX, 2, 6, InstructionFlags::None,
		    std::bind(&MOS6502::ins_cmp, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.CPY_ZP,
		...
		{ Opcodes.DEC_ZP,
		  { "dec", AddressingMode::ZeroPage, 2, 5, InstructionFlags::None,
		    std::bind(&MOS6502::ins_dec, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.INY_IMP,
		  { "iny", AddressingMode::Implied, 1, 2, InstructionFlags::None,
		    std::bind(&MOS6502::ins_iny, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.CMP_IMM,
		  { "cmp", AddressingMode::Immediate, 2, 2, InstructionFlags::None,
		    std::bind(&MOS6502::ins_cmp, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.DEX_IMP,
		  { "dex", AddressingMode::Implied, 1, 2, InstructionFlags::None,
		    std::bind(&MOS6502::ins_dex, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.CPY_ABS,
		...
		{ Opcodes.BNE_REL,
		  { "bne", AddressingMode::Relative, 2, 2, InstructionFlags::Branch,
		    std::bind(&MOS6502::ins_bne, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.CMP_IDY,
		...
		{ Opcodes.CLD_IMP,
		  { "cld", AddressingMode::Implied, 1, 2, InstructionFlags::None,
		    std::bind(&MOS6502::ins_cld, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.CMP_ABY,
		...
		{ Opcodes.CPX_IMM,
		  { "cpx", AddressingMode::Immediate, 2, 2, InstructionFlags::None,
		    std::bind(&MOS6502::ins_cpx, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.SBC_IDX,
		  { "sbc", AddressingMode::IndirectX, 2, 6, InstructionFlags::None,
		    std::bind(&MOS6502::ins_sbc, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.CPX_ZP,
		...
		{ Opcodes.INC_ZP,
		  { "inc", AddressingMode::ZeroPage, 2, 5, InstructionFlags::None,
		    std::bind(&MOS6502::ins_inc, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.INX_IMP,
		  { "inx", AddressingMode::Implied, 1, 2, InstructionFlags::None,
		    std::bind(&MOS6502::ins_inx, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.SBC_IMM,
		  { "sbc", AddressingMode::Immediate, 2, 2, InstructionFlags::None,
		    std::bind(&MOS6502::ins_sbc, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.NOP_IMP,
		  { "nop", AddressingMode::Implied, 1, 2, InstructionFlags::None,
		    std::bind(&MOS6502::ins_nop, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.CPX_ABS,
		...
		{ Opcodes.BEQ_REL,
		  { "beq", AddressingMode::Relative, 2, 2, InstructionFlags::Branch,
		    std::bind(&MOS6502::ins_beq, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.SBC_IDY,
		...
		{ Opcodes.SED_IMP,
		  { "sed", AddressingMode::Implied, 1, 2, InstructionFlags::None,
		    std::bind(&MOS6502::ins_sed, this, std::placeholders::_1, std::placeholders::_2)}},
		{ Opcodes.SBC_ABY,
